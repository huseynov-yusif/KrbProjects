...
{
    public class WhatWeDoCreateCommand : IRequest<int>
    {
        ...
        public class WhatWeDoCreateCommandHandler : IRequestHandler<WhatWeDoCreateCommand, int>
        {
            readonly KrbProjectsBaseDbContext db;
            readonly IActionContextAccessor ctx;
            readonly IWebHostEnvironment env;
            public WhatWeDoCreateCommandHandler(KrbProjectsBaseDbContext db, IActionContextAccessor ctx, IWebHostEnvironment env)
            {
                this.ctx = ctx;
                this.db = db;
                this.env = env;
            }
            public async Task<int> Handle(WhatWeDoCreateCommand request, CancellationToken cancellationToken)
            {
