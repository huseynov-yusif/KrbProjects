+(function ($) {
    ...
    (Plugin = function (action, options) {
        ...
        return (
            ...
            this.each(function () {
                ...
                ($this = $(this)),
                    ...
                    data || ((data = new TtaAutoPlay($this, $.extend(!0, {}, TtaAutoPlay.DEFAULTS, $this.data("vc-tta-autoplay"), options))), $this.data("vc.tta.autoplay", data)),
        ...
        (TtaAutoPlay.DEFAULTS = { delay: 5e3, pauseOnHover: !0, stopOnClick: !0 }),
        ...
        (TtaAutoPlay.prototype.start = function () {
            ...
            ($this = this.$element),
                ...
                (this.setTimer(window.setInterval(this.show.bind(this), this.options.delay)),
                    this.options.stopOnClick && $this.on("click.vc.tta.autoplay.data-api", "[data-vc-accordion]", stopHandler),
