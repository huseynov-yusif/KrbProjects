+(function ($) {
    ...
    (Accordion = function ($element, options) {
        ...
        (Accordion.transitionEvent = function () {
            ...
            (el = document.createElement("vcFakeElement")), (transitions = { transition: "transitionend", MSTransition: "msTransitionEnd", MozTransition: "transitionend", WebkitTransition: "webkitTransitionEnd" });
            ...
            return (
                ...
                this.isCacheUsed()
                    ? (void 0 === this.$targetContent &&
                        (($targetContent = $target), $target.data("vcContent") && (($targetContent = $target.find($target.data("vcContent"))), $targetContent.length || ($targetContent = $target)), (this.$targetContent = $targetContent)),
                        this.$targetContent)
                    : $target.data("vcContent") && (($targetContent = $target.find($target.data("vcContent"))), $targetContent.length)
                        ? $targetContent
                        : $target
            );
        }),
                        ...
                        $target
                            ...
                            .queue(function (next) {
                                $target.addClass(that.animatingClass),
                                    ...
                                    (("object" == typeof opt && opt.hasOwnProperty("changeHash") && opt.changeHash) || void 0 === opt) && that.changeLocationHash(),
