    ...
    jQuery.fn.extend({
        ...
        revstart: function () {
            ...
            if (e != undefined && e.length > 0 && jQuery("body").find("#" + e.attr("id")).length > 0 && e[0].opt !== undefined)
                return e[0].opt.sliderisrunning ? (console.log("Slider Is Running Already"), !1) : ((e[0].opt.c = e), (e[0].opt.ul = e.find(">ul")), runSlider(e, e[0].opt), !0);
        },
        revnext: function () {
            return this.each(function () {
                var e = jQuery(this);
                    ...
                    e.find(".tp-caption, .rs-background-video-layer").each(function (e) {
                        ...
                        if (
                            ...
                            var p = t.hasClass("slidelink") ? "width:100% !important;height:100% !important;" : "",
                                ...
                                y = "";
                            "row" === v
                                ? (t.addClass("rev_row").removeClass("tp-resizeme"), (y = "rev_row_wrap"))
                                : "column" === v
                                    ? ((g = f.verticalalign === undefined ? " vertical-align:bottom;" : " vertical-align:" + f.verticalalign + ";"),
                                        (y = "rev_column"),
                            ...
                            "row" !== v && "group" !== v && "column" !== v
                                ? ((w = "display:" + t.css("display") + ";"),
                                    t.closest(".rev_column").length > 0 ? (t.addClass("rev_layer_in_column"), (l = !1)) : t.closest(".rev_group").length > 0 && (t.addClass("rev_layer_in_group"), (l = !1)))
                                : "column" === v && (l = !1),
        ...
        swapSlideProgress = function (e, i) {
            ...
            if (((o.currentSlide = t.index()), (o.nextSlide = a.index()), "carousel" == o.sliderType)) (u = new punchgs.TimelineLite()), _R.prepareCarousel(o, u), letItFree(i, r, n, a, t, u), (o.transition = 0), (o.firststart = 0);
                ...
                o.ie && ("boxfade" == h && (h = "boxslide"), "slotfade-vertical" == h && (h = "slotzoom-vertical"), "slotfade-horizontal" == h && (h = "slotzoom-horizontal")),
                    ...
                    "on" == r.data("kenburns") && (_R.startKenBurn(r, o), u.add(punchgs.TweenLite.set(r, { autoAlpha: 0 }))),
                    u.pause();
            }
            _R.scrollHandling &&
                    ...
                    ? "carousel" === o.sliderType && "on" === o.carousel.showLayersAllTime
                        ? (jQuery.each(o.li, function (e) {
                            o.carousel.allLayersStarted
                                ...
                                : o.li[e] === a
                                    ? _R.animateTheCaptions({ slide: jQuery(o.li[e]), maintimeline: u, opt: o, startslideanimat: 0 })
                                    : _R.animateTheCaptions({ slide: jQuery(o.li[e]), opt: o, startslideanimat: 0 });
                        }),
                            (o.carousel.allLayersStarted = !0))
                        : _R.animateTheCaptions({ slide: a, opt: o, maintimeline: u, startslideanimat: 0 })
                    : u != undefined &&
                    setTimeout(function () {
                        u.resume();
                    }, 30),
